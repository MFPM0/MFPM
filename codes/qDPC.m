...
data_path     = 'D:\Temp\DPC\FanYao\matlab_code\data\'; %PUT YOUR DATA PATH HERE
...
na            = 0.30;                           % numerical aperture of the imaging system
na_illum      = sigma*na;                       % numerical aperture of the illumination
magnification = 10;                           % magnification of the imaging system
lambda        = 0.514;                          % wavelength in micron
ps            = 4/magnification;              % pixel size in micron
...
ax2 = subplot(1, 2, 2);
imagesc(x, y, phase); axis image; axis off; colormap(ax2, 'gray'); colorbar;
